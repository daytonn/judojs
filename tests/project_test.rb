...
class TC_TestProject < Test::Unit::TestCase
  ...
  def setup
    @test_project = Judo::Project.new('MyApplication', 'js')
    @path = File.dirname(__FILE__)
  end
  
  def test_can_initialize_project
    assert_equal('myapplication', @test_project.app_filename, 'test_project.app_filename')
    assert_equal('/Volumes/Storage/Development/judo/tests/js/', @test_project.project_path, 'test_project.project_path')
  ...
  def test_can_create_project
    ...
    assert(File.exists?('/Volumes/Storage/Development/judo/tests/js/application/myapplication.js'), 'application/myapplication.js was created successfully')
    assert(File.exists?('/Volumes/Storage/Development/judo/tests/js/lib/judo.js'), 'lib/judo.js was created successfully')
    assert(File.exists?('/Volumes/Storage/Development/judo/tests/js/lib/utilities.js'), 'lib/utilities.js was created successfully')
  ...
  def test_judo_application_content
    expected_file = File.open("/Volumes/Storage/Development/Judo/tests/fixtures/myapplication.js", "r")
    actual_file = File.open("/Volumes/Storage/Development/Judo/tests/js/application/myapplication.js", "r")
  ...
  def test_library_files_content
    expected_judo_lib_file = File.open("/Volumes/Storage/Development/Judo/tests/fixtures/judo.js", "r")
    ...
    expected_utility_lib_file = File.open("/Volumes/Storage/Development/Judo/tests/fixtures/utilities.js", "r")
    utility_lib_file = File.open("/Volumes/Storage/Development/Judo/tests/js/lib/utilities.js", "r")
  ...
  def test_can_initialize_configuration
    test_config = Judo::Configuration.new '/Volumes/Storage/Development/judo/tests/js/', 'MyApplication'
    test_config.read
    assert_equal(test_config.project_path, '/Volumes/Storage/Development/judo/tests/js/')
